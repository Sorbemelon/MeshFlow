    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5">
          {state === "loading" ? (
            <p className="inline-flex items-center gap-2 rounded-md bg-surface-muted px-3 py-2 text-sm text-ink-muted">
              <InlineSpinner />
              ...
              <section className="rounded-lg border border-emerald-200 bg-emerald-50/50 p-4">
                ...
                <div className="mt-3 flex flex-wrap gap-2 text-xs">
                  <span className="rounded-full border border-slate-200 bg-white px-2.5 py-1 text-slate-700">
                    Dataset:{" "}
                    {displayDatasetName(
                      detail.analysis_run.dataset_name,
                      detail.analysis_run.dataset_id,
                    )}
                  </span>
